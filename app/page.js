        ...
        <div className="p-4 mt-4 z-10 w-full max-w-4xl flex-col items-center justify-between font-mono text-sm">
          <div className="bg-slate-600 p-4 rounded-xl">
            <form className="grid grid-col-1 sm:grid-cols-7 items-center text-black">
              <input onChange={(e) => { setnewTransc({ ...newTransc, person: e.target.value }) }} className="col-span-1 sm:col-span-2 p-4 border border-slate-800 rounded-lg  " type="text" name="" id="" placeholder="Payed by" />
              <input onChange={(e) => { setnewTransc({ ...newTransc, desc: e.target.value }) }} className="col-span-1 sm:col-span-2 p-4 border border-slate-800 rounded-lg" type="text" name="" id="" placeholder="Description" />
              <input onChange={(e) => { setnewTransc({ ...newTransc, amount: e.target.value }) }} className="col-span-1 sm:col-span-2 p-4 border border-slate-800 rounded-lg" type="text" name="" id="" placeholder="Enter Amount" />
            ...
            <ul>
              {transc.map((item, id) => {
                return (
                  <li key={id} className="my-2 w-full flex justify-between">
