...
const AddFriend = () => {
  ...
  return (
    <div className='mt-8 bg-slate-600 m-4 border border-slate-400 rounded-lg p-4'>
        <div className='text-bold font-medium text-3xl lg:text-xl text-center'>
        ...
        <form className='flex mt-4 justify-center items-center max-w-xl'>
            ...
            <button className='p-3 flex font-medium text-xl border border-slate-500 bg-slate-800 rounded-md w-10 h-10 items-center'>+</button>
        </form>
    </div>
  )
}
